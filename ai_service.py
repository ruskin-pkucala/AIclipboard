...
class AIService:
    ...
    def correct_text(
        ...
        prompts = {
            "correct": """请仔细检查并纠正以下文本中的错别字、标点符号错误和语法问题。

先直接输出纠错后的完整文本，然后另起一行输出"---"分隔符，再列出具体的修改内容及其原因（每条修改用"1.、2.、3."编号）。
